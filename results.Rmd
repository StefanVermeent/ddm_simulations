...
The first figure shows model convergence (i.e., whether the model was able to converge on a stable solution).
...
Parameter recovery was excellent for most parameters.
Recovery of incongruent non-decision times was slightly lower, but still reasonably high.
...
Just like with the Flanker, drift rates and boundary separation were recovered with high accuracy, while the recovery of the non-decision time (for congruent trials) was quite low.
