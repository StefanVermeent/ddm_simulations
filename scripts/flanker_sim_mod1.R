...
ddm_fm_cor_mod1 <- ddm_fm_data_mod1 |>
  group_by(parameter) |>
  summarise(r = cor(estimated, groundtruth))


save(ddm_fm_traces_mod1, ddm_fm_data_mod1, ddm_fm_cor_mod1, file = "analysis_objects/ddm_fm_mod1_results.RData")
